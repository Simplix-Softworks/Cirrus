...
public interface MenuEffect<T> {
  ...
  /**
   * Duration is measured in MC-ticks.
   * The effect length describes the duration between each frame of the
   * effect/animation in ticks
   *
  ...
  /**
   * Each effect/animation output is calculated based on an input.
   * Based on this input a List of outputs E.G (frames) is generated.
   *
