...
public class NextMenu extends SimpleMenu {
  ...
  public NextMenu() {
    ...
    set(CirrusItem.of(iterator.next(), ChatElement.ofLegacyText("§aClick")).slot(9 * 2 + 4).actionHandler("click"));

    row(5).get(8).set(CirrusItem.of(ItemType.DARK_OAK_DOOR, ChatElement.ofLegacyText("§7Back")).actionHandler("back"));
